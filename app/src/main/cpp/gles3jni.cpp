...
extern "C" {
    JNIEXPORT void JNICALL Java_com_krz_DemoGLJNIYo_GLES3JNILib_init(JNIEnv* env, jobject obj);
    JNIEXPORT void JNICALL Java_com_krz_DemoGLJNIYo_GLES3JNILib_resize(JNIEnv* env, jobject obj, jint width, jint height);
...
Java_com_krz_DemoGLJNIYo_GLES3JNILib_init(JNIEnv* env, jobject obj) {
